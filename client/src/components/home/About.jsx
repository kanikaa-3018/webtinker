          ...
          <Row className="g-5 align-items-center">
            <Col lg={6}>
              <motion.div variants={fadeInUp}>
                ...
                <Link to="/workshop" className="btn btn-primary py-3 px-5 mt-2" style={{ backgroundColor: '#41aff8' }}>
                  View More Workshops
                </Link>
              </motion.div>
            </Col>
            ...
            <Col lg={6}>
              <motion.div className="text-center" variants={fadeInUp} transition={{ delay: 0.3 }}>
                <img
